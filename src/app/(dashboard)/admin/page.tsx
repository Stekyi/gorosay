...
const SETTING_LABELS: Record<string, { label: string; type: string; section: string }> = {
  ...
  email_from_name: { label: "Sender Name", type: "text", section: "email" },
  email_from_address: { label: "Gmail Address", type: "email", section: "email" },
  email_smtp_username: { label: "SMTP Username (leave blank to use Gmail address)", type: "text", section: "email" },
  email_app_password: { label: "Gmail App Password", type: "password", section: "email" },
  email_smtp_host: { label: "SMTP Host (smtp.gmail.com)", type: "text", section: "email" },
  email_smtp_port: { label: "SMTP Port (465)", type: "text", section: "email" },
